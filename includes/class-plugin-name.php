...
class Plugin_Name {
	...
	private function define_admin_hooks() {
		...
		//Original loads styles site wide
		//$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_admin_css' );
		//$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_admin_js' );
